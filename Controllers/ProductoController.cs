...
namespace appejemplo2.Controllers
{
    public class ProductoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Precio,Descripcion,PDescuento,ImagenName,Status")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Precio,Descripcion,PDescuento,ImagenName,Status")] Producto producto)
        {
            if (id != producto.Id)
            {
                return NotFound();
